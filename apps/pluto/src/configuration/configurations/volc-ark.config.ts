...
export default registerAs<Record<VolcArkPropertyToken, Partialable<string>>>(
  ...
  () => ({
    [VOLC_ARK_PROPERTY_TOKENS.ARK_CABIN_CAB_API_KEY]:
      process.env.ARK_CABIN_CAB_API_KEY,
    [VOLC_ARK_PROPERTY_TOKENS.ARK_CABIN_CAB_BASE_URL]:
      process.env.ARK_CABIN_CAB_BASE_URL,
    [VOLC_ARK_PROPERTY_TOKENS.ARK_CABIN_CAB_MODEL]:
      process.env.ARK_CABIN_CAB_MODEL,
  }),
);
